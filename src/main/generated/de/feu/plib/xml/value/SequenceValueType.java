...
public class SequenceValueType
    ...
    implements Serializable, ToString
{
    ...
    protected List<AbstractXMLType> valueGroup;
     ...
     * 
     */
    public List<AbstractXMLType> getValueGroup() {
        if (valueGroup == null) {
            valueGroup = new ArrayList<AbstractXMLType>();
        }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<AbstractXMLType> theValueGroup;
